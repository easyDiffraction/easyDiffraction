...
QtObject {
    ...
    readonly property string appIconPath: qmlImportsDirUrl + "/easyDiffraction/Resources/Icons/App.svg"
    readonly property string essIconPath: qmlImportsDirUrl + "/easyDiffraction/Resources/Icons/ESSlogo.png"
}
