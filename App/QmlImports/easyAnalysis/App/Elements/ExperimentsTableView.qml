    ...
    Rectangle {
        ...
        Column {
            ...
            ListView {
                ...
                model: Generic.Variables.projectOpened ? Specific.Variables.project.info.experiment_ids : 1
                ...
                delegate: Rectangle {
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            font.family: Generic.Style.fontFamily
                            font.pointSize: Generic.Style.fontPointSize
                            text: Generic.Variables.projectOpened ? Specific.Variables.project.info.experiment_ids[index] : ""
                            color: foregroundColor()
                        }
