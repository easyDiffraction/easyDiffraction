...
QtObject {
    ...
    readonly property string appVersion: proxyPyQmlObj._releaseInfo ? proxyPyQmlObj._releaseInfo.version : ""
    readonly property string appDate: proxyPyQmlObj._releaseInfo ? proxyPyQmlObj._releaseInfo.date : ""
