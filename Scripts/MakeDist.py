...
args = ['pyinstaller', '{0}/App/{1}.py'.format(project_dir_path, project_name),
        ...
        '--distpath', "{0}/dist".format(project_dir_path), # Where to put the bundled app (default: ./dist)
        '--workpath', "{0}/build".format(project_dir_path) # Where to put all the temporary work files, .log, .pyz and etc. (default: ./build)
        ]
