...
ComboBox {
    ...
    contentItem: T.TextField {
        ...
        font: control.font
        color: Generic.Style.buttonTextEnabledColor //control.enabled ? Generic.Style.buttonTextEnabledColor : Generic.Style.buttonTextDisabledColor //control.editable ? control.palette.text : control.palette.buttonText
    ...
    background: Rectangle {
        ...
        color: Generic.Style.buttonBkgEnabledColor //backgroundColor()
